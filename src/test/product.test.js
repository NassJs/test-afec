...
dotenv.config()
// // Définir la base de données pour les tests
// const testDatabase = process.env.MONGODB_URI

// let productId;

// beforeAll(async () => {
//   // Connexion à la base de données de test avant tous les tests
//   await mongoose.connect(testDatabase, { useNewUrlParser: true, useUnifiedTopology: true });
// });

// afterAll(async () => {
//   // Nettoyage de la base de données et fermeture de la connexion après les tests
